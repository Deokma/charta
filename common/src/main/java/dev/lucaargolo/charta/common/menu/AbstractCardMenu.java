...
import dev.lucaargolo.charta.common.utils.CardContainerListener;
import dev.lucaargolo.charta.common.utils.CardContainerSynchronizer;
...
public abstract class AbstractCardMenu<G extends Game<G, M>, M extends AbstractCardMenu<G, M>> extends AbstractContainerMenu {
    ...
    public AbstractCardMenu(MenuType<?> menuType, int containerId, Inventory inventory, Definition definition) {
        ...
        this.game = GameType.getGameForMenu(this.getGameType(), this.access, this.deck, definition.players(), definition.options());
    ...
    public void removed(@NotNull Player player) {
        ...
        if (!carriedCards.isEmpty()) {
            for(Card carriedCard : carriedCards.getCards()) {
                ...
                this.getGame().getCensoredHand(this.cardPlayer).add(new Card());
            }
