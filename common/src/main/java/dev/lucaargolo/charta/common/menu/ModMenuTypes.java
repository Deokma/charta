...
public class ModMenuTypes {
    ...
    public static final ModMenuTypeRegistry.AdvancedMenuTypeEntry<TileKingdomsMenu, AbstractCardMenu.Definition> TILE_KINGDOMS = REGISTRY.register("tile_kingdoms", TileKingdomsMenu::new, AbstractCardMenu.Definition.STREAM_CODEC);
