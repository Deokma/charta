...
//import dev.lucaargolo.charta.common.game.impl.blackjack.BlackjackGame;
...
public class Games {
    ...
    public static final MinecraftEntry<GameType<dev.lucaargolo.charta.common.game.impl.tilekingdoms.TileKingdomsGame, dev.lucaargolo.charta.common.game.impl.tilekingdoms.TileKingdomsMenu>> TILE_KINGDOMS = MOD_REGISTRY.register("tile_kingdoms", () -> dev.lucaargolo.charta.common.game.impl.tilekingdoms.TileKingdomsGame::new);
